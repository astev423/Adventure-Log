...
-ScrollView, wrap, all important for different screen sizes, if content takes too much width just turn it into a col with
wrap or use layoutbuilder with screen size query
